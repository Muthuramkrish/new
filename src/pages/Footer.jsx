      ...
      <div className="max-w-7xl mx-auto py-8 md:py-12 px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 hover:text-green-300 transition-colors">
              <div className="flex items-center gap-2">
                <FaPhoneAlt className="text-green-400 text-base md:text-lg flex-shrink-0" />
                <a href="tel:+917598895773" className="text-xs md:text-sm font-medium">
                  +91 75988 95773
                </a>
              </div>
              <div className="flex items-center gap-2">
                <FaPhoneAlt className="text-green-400 text-base md:text-lg flex-shrink-0" />
                <a href="tel:+917598865773" className="text-xs md:text-sm font-medium">
                  +91 75988 65773
                </a>
              </div>
            </div>
